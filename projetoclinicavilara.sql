...
--
-- Máquina: localhost
-- Data de Criação: 10-Set-2016 às 18:35
...
--
-- Base de Dados: `projetoclinicavilara`
--
CREATE DATABASE IF NOT EXISTS `projetoclinicavilara` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `projetoclinicavilara`;
...
CREATE TABLE IF NOT EXISTS `agendamento` (
  ...
  `agenda_codpac` int(11) NOT NULL,
  `agenda_turno` varchar(45) NOT NULL,
  `agenda_codmedico` int(11) NOT NULL,
  `agenda_data` varchar(45) NOT NULL,
  `agenda_motivo` text NOT NULL,
  `agenda_status` varchar(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bairro` (
  `bairro_cod` int(11) NOT NULL AUTO_INCREMENT,
  `bairro_nome` varchar(65) NOT NULL,
...
INSERT INTO `bairro` (`bairro_cod`, `bairro_nome`) VALUES
(1, 'Compensa'),
(2, 'Cidade Nova'),
(3, 'Viearalves'),
(4, 'Pq 10'),
...
CREATE TABLE IF NOT EXISTS `cidades` (
  `estados_cod_estados` int(11) NOT NULL DEFAULT '0',
  ...
  PRIMARY KEY (`cod_cidades`,`estados_cod_estados`),
  KEY `fk_cidades_estados1_idx` (`estados_cod_estados`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=11060 ;
...
CREATE TABLE IF NOT EXISTS `medicos` (
  ...
  `especialidade_medico` varchar(256) NOT NULL,
...
INSERT INTO `medicos` (`idMedicos`, `nome_medico`, `especialidade_medico`, `crm_medico`) VALUES
(22, 'jjjj77777', 'Pediatra', 1234),
(24, '24', 'Pediatra', 99999),
(25, 'rrrr', 'Pediatra', 44444),
(30, 'sdflsjdlfj', 'Pediatra', 1212),
(31, 'sfsadrr', 'Pediatra', 222222),
(32, 'wuyut', 'Pediatra', 77777),
(34, 'sdfsdf', 'Pediatra', 5555),
(35, 'sfsd', 'Pediatra', 9999),
(36, 'sdfsd', 'Pediatra', 5555),
(37, 'weqwe', 'Pediatra', 77777),
(40, 'sdfsdf', 'Pediatra', 666666),
(41, 'sdfsdf', 'Pediatra', 33332222),
(42, 'sdlfslkadf', 'Pediatra', 1211212),
(47, 'hsdjfhksdhfk', 'Pediatra', 1111111),
(49, 'eee', 'Pediatra', 222),
(51, 'rtyrty3333', 'Pediatra', 2123);
...
CREATE TABLE IF NOT EXISTS `pacientes` (
  ...
  `pac_rg` varchar(64) NOT NULL,
  `pac_email` varchar(64) DEFAULT NULL,
  `pac_telefone` varchar(64) NOT NULL,
  `pac_rua` varchar(64) NOT NULL,
  `pac_nr` int(11) NOT NULL,
  `pac_complemento` varchar(64) NOT NULL,
  `pac_bairro` int(64) NOT NULL,
  `pac_estado` int(64) NOT NULL,
  `pac_cidades` int(64) DEFAULT NULL,
...
INSERT INTO `pacientes` (`idPaciente`, `pac_nome`, `pac_nascimento`, `pac_rg`, `pac_email`, `pac_telefone`, `pac_rua`, `pac_nr`, `pac_complemento`, `pac_bairro`, `pac_estado`, `pac_cidades`) VALUES
(6, 'reresssss', '2016-08-02', '11', '11', '11', '11', 11, '11', 5, 1, 1),
(11, '333', '2016-08-04', '333', '33', '33', '33', 33, '33', 5, 1, 1),
(13, '55', '2016-08-02', '99', '99', '9', '99', 99, '99', 5, 4, 196);
...
INSERT INTO `usuarios` (`usu_cod`, `usu_nome`, `usu_senha`, `usu_tipo`) VALUES
(8, 'tetet', '11111', 'Administrador'),
(9, 'rrrr', '12', 'Administrador'),
(11, 'vilara', '123', 'Administrador'),
(12, 'marco', '123', 'Recepcionista');
